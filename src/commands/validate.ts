...
export default class Validate extends SleekCommand {
  ...
  static flags = {
    ...
    directory: Flags.string({
      description: "Path to the addon folder",
      hidden: true,
      char: 'd',
      exclusive: ['file', 'helmUrl']
    }),  // internal and for partner users who would like to test against their local code
    helmUrl: Flags.string({
      description: "Fully qualified URL of the Repo",
      exclusive: ['file']
    }),  // fully qualified URL of helm repo
    helmRepo: Flags.string({
      description: "Helm repo of the addon",
      exclusive: ['file', 'helmUrl'],
      char: 'r'

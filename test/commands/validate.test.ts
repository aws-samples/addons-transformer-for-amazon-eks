...
describe('validate', () => {
  ...
  describe('validate --file validate.not_valid.yaml', () => {
    test
      .stderr()
      .stdout()
      .command(['validate',
        '--file', // avoid creation of the actual issue con GitHub
        './test/commands/resources/validate.not-valid.yaml',
      ])
      .catch(error => {
  ...
  describe('validate --file validate.valid.yaml', () => {
    test
      .stdout()
      .command(['validate',
          '--file', // avoid creation of the actual issue con GitHub
          './test/commands/resources/validate.valid.yaml',
        ]
